...
TEST(BitsetTest, Construction) {
    ...
    bitset b(4, 0);  // 4 bits starting from variable 0
    ...
    bitset value_bitset(4, 5);  // 4-bit representation using variables starting from 5
...
TEST(BitsetTest, LogicalOperations) {
    ...
    bitset a(2, 0);  // 2 bits using variables 0-1
    bitset b(2, 2);  // 2 bits using variables 2-3
...
TEST(BitsetTest, ShiftOperations) {
    ...
    bitset b(4, 0);  // 4 bits using variables 0-3
    
    // Left shift by 1
    bitset left_shift = b << 1;
